...
# operating system:  Linux 2.0.30 i686 [ELF] (2.0.30)
# libc:	(6.4.0)
# binutils:	(28)
...
#          CC = purify gcc
      ...
      CDEBUGFLAGS = -g
        MANSUFFIX = 8
         ...
         MANIFEST = README ACKNOWLEDGEMENTS ChangeLog Imakefile Makefile  					XMotd XMotd_motif xmotd.8 xlogo.bm $(SRCS) $(INCLUDES)
